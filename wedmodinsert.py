# -*- coding: utf-8 -*-
"""
Created on Wed Jun 26 18:06:32 2019
...
# checkpoint
filepath = "my_folder/text-gen-best.hdf5"
...
print("Database opened successfully")  
cur = con.cursor()  
cur.execute("insert into sldcsch.fcast_model_weights(rtu_point_id,model_json,weights,trained_from_date,trained_to_date,trained_for_day,training_execute_date) values('13008','"+modeljson+"','"+weightsjson+"','"+dates_list[0]+"','"+dates_list[-1]+"','"+str(weekd)+"','2019-06-26')")
con.commit()