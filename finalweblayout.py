# -*- coding: utf-8 -*-
"""
Created on Tue Jul  9 17:22:49 2019
...
anpdf1 = realdf.iloc[15:720:30,:]
anpdf2 = realdf.iloc[29:720:30,:]

anpdf3 = predf.iloc[15:720:30,:]
anpdf4 = predf.iloc[29:720:30,:]

anpdf5 = yesdf.iloc[15:720:30,:]
anpdf6 = yesdf.iloc[29:720:30,:]

hrlist = pd.merge(anpdf1,anpdf2,how = "outer").sort_values("time")
hplist = pd.merge(anpdf3,anpdf4,how = "outer").sort_values("timelist")
hylist = pd.merge(anpdf5,anpdf6,how = "outer").sort_values("timelist") 
...
datap = [{'time':hplist.iloc[-2,0].strftime("%H:%M"),'value' : hplist.iloc[-2,1]},{'time':hplist.iloc[-1,0].strftime("%H:%M"),'value' : hplist.iloc[-1,1]}]
    ...
    html.Div([
       ...
       style_cell={
        ...
        html.Div([
            ...
            data=datap,
            fixed_rows={ 'headers': True, 'data': 0 },
            style_cell={'width': '300px','height': '150px', 'font_size': '40px','text_align': 'center','display': 'inline-block'},
        ),
        ], className="six columns"),
    ], className="row"),
    html.Div([
